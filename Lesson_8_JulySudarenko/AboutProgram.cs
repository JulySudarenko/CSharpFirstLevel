...
namespace Lesson_8_JulySudarenko
{
    partial class AboutProgram : Form
    {
        public AboutProgram()
        {
            ...
            textBoxDescription.Text = $"Редактор для игры \"Верю - Не верю\" позволяет создать базу данных вопросов о необычных вещах в нашей жизни. Ответы могут быть только да или нет.";
        }
